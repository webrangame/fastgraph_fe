...
const baseQueryWithRefresh = async (args, api, extraOptions) => {
  // Use external base query for payment plans endpoint
  const isExternalEndpoint = args.url && args.url.includes('/api/v1/payment/plans');
  const query = isExternalEndpoint ? externalBaseQuery : baseQuery;
